  ...
  <div class="row">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
       <div class="form-group">
          ...
          <div class="col-sm-9">
        <input name="oid" type="text" class="form-control" id="orderid" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>">
      </div>
      </div>
      <div class="form-group">
      ...
      <tr>
        ...
        <td>
          <a href="orders_details.php?oid=<?php echo $orderrow['fld_order_id']; ?>" class="btn btn-success btn-xs" role="button">Details</a>
           <button class="btn btn-success btn-xs" onclick="window.location.href='orders.php?edit=<?php echo $readrow['fld_order_id']; ?>';" <?php if ($pos== "Normal Staff"){ ?> style="display: none"<?php   } ?>>Edit</button>
          <button class="btn btn-danger btn-xs" onclick="window.location.href='orders.php?delete=<?php echo $readrow['fld_order_id']; ?>'; return confirm('Are you sure to delete?');" <?php if ($pos== "Normal Staff"){ ?> style="display: none"<?php   } ?>>Delete</button>
        </td>
      </tr>
      <?php
      }
