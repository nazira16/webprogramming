    ...
    <form action="products.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
         ...
         <select name="brand" class="form-control" id="productbrand" required>
            ...
            <option value="Karrimor" <?php if(isset($_GET['edit'])) if($editrow['FLD_BRAND']=="Karrimor") echo "selected"; ?>>Karrimor</option>
            <option value="North Face" <?php if(isset($_GET['edit'])) if($editrow['FLD_BRAND']=="North Face") echo "selected"; ?>>North Face</option>
            <option value="Salomon" <?php if(isset($_GET['edit'])) if($editrow['FLD_BRAND']=="Salomon") echo "selected"; ?>>Salomon</option>
          </select>
        </div>
        </div>     
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input name="type" type="radio" id="producttype" value="Backpacking Boots" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="Backpacking Boots") echo "checked"; ?> required> Backpacking Boots
            </label>
          </div>
          <div class="radio">
            <label>
              <input name="type" type="radio" id="producttype" value="Day Hiking Boots" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="Day Hiking Boots") echo "checked"; ?>> Day Hiking Boots
            </label>
            </div>
            <div class="radio">
            <label>
              <input name="type" type="radio" id="producttype" value="Hiking Shoes" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="Hiking Shoes") echo "checked"; ?> required> Hiking Shoes
            </label>
          </div>
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="quantity" type="number" class="form-control" id="productq" placeholder="Product Quantity" value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_QUANTITY']; ?>"  min="0" required>
        </div>
        </div>
        <div class="form-group">
